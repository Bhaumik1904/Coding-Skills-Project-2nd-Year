    ...
    for (let i = 0; i < cargo.length && remaining > 0; i++) {
      ...
      if (remaining >= item.weight) {
        ...
        steps.push({
          ...
          desc: `Naive approach loads ${item.name} (${item.weight} tons) without ratio analysis`,
          loaded: [...loaded],
          remaining,
          totalProfit,
        });
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">Optimal Selection</p>
            ...
            >
              ...
              <p className="text-sm text-gray-600">Sequential Loading</p>
              <p className="text-xs text-gray-500 mt-2">
                No ratio analysis, loads in order
              </p>
            </button>
          </div>
        </div>
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart
                    data={greedySteps.map((s, idx) => ({
                      step: idx,
                      'Greedy Algorithm': Number(
                        s.totalProfit.toFixed(1),
                      ),
                      'Naive Selection': Number(
                        (
